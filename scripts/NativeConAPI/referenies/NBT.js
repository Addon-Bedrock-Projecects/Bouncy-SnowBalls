...
const functionWrite = {
    ...
    [NumberType](NumberParam){
        ...
        return GetChar(charcode1,charcode2);
    },
    [FloatType](NumberParam){
        ...
        return GetChar(charcode1,charcode2,charcode3,charcode4);
    },
    [BooleanType](BooleanParam){
        return GetChar(BooleanParam?1:0);
    }
}
const functionRead = {
    [ArrayType](tReader){
    ...
    [NumberType](tReader){
        ...
        let charcode1 = 0x0000ffff & TextN.charCodeAt(0);
        charcode1 |= 0xffff0000 & (TextN.charCodeAt(1)<<16);
    ...
    [FloatType](tReader){
        ...
        let charcode1 = 0x0000ffff & TextN.charCodeAt(0);
        charcode1 |= 0xffff0000 & (TextN.charCodeAt(1)<<16);
        let charcode2 = 0x0000ffff & TextN.charCodeAt(2);
        charcode2 |= 0xffff0000 & (TextN.charCodeAt(3)<<16);
        return Number(charcode1 + '.' + charcode2);
    },
    [BooleanType](tReader){

        return Boolean(tReader.readByte());
    }
}
